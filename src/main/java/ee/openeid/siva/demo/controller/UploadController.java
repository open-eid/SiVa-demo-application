...
import static ee.openeid.siva.demo.siva.ValidationReportUtils.*;
...
class UploadController {
    ...
    private String getJsonValidationResult() {
        return validationTaskRunner.getValidationResult();
    }

    private String getHashcodeJsonValidationResult() {
        return hashcodeValidationTaskRunner.getValidationResult();
    }

    private String getJsonDataFilesResult() {
        return dataFilesTaskRunner.getDataFilesResult();
    }
